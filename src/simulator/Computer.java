...
public class Computer {
    ...
    /**
     * Set the input file for the card reader (device 2)
...
//        Assembler.assembleFile("data/load_store_test.txt", "data/listing.txt", "data/load.txt");
